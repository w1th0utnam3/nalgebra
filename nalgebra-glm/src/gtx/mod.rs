...
pub use self::{
    exterior_product::cross2d,
    handed_coordinate_space::{left_handed, right_handed},
    matrix_cross_product::{matrix_cross, matrix_cross3},
    matrix_operation::{
        diagonal2x2, diagonal2x3, diagonal2x4, diagonal3x2, diagonal3x3, diagonal3x4, diagonal4x2,
        diagonal4x3, diagonal4x4,
    },
    norm::{distance2, l1_distance, l1_norm, l2_distance, l2_norm, length2, magnitude2},
    normal::triangle_normal,
    normalize_dot::{fast_normalize_dot, normalize_dot},
    quaternion::{
    ...
    rotate_normalized_axis::{quat_rotate_normalized_axis, rotate_normalized_axis},
    rotate_vector::{
    ...
    transform::{rotation, rotation2d, scaling, scaling2d, translation, translation2d},
    transform2::{
        proj, proj2d, reflect, reflect2d, scale_bias, scale_bias_matrix, shear2d_x, shear2d_y,
        shear_x, shear_y, shear_z,
    },
    transform2d::{rotate2d, scale2d, translate2d},
    vector_angle::angle,
    vector_query::{
